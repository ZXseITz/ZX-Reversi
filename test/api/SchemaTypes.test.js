...
test('test password type', () => {
    ...
    expect(Schema.Types.password("testtest")).toBeTruthy();
    expect(Schema.Types.password("testtest0")).toBeTruthy();
    expect(Schema.Types.password("test_test")).toBeTruthy();
    expect(Schema.Types.password("test-test")).toBeTruthy();
    expect(Schema.Types.password("test.test")).toBeTruthy();
    expect(Schema.Types.password("test@test")).toBeTruthy();
    expect(Schema.Types.password("test#test")).toBeTruthy();
    expect(Schema.Types.password("test$test")).toBeTruthy();
    ...
    expect(Schema.Types.password("test^test")).toBeTruthy();
    expect(Schema.Types.password("test&test")).toBeTruthy();
    expect(Schema.Types.password("test:test")).toBeFalsy();
    expect(Schema.Types.password("test;test")).toBeFalsy();
    expect(Schema.Types.password("test/test")).toBeFalsy();
    expect(Schema.Types.password("{$exists: true}")).toBeFalsy();
    expect(Schema.Types.password("testtesttesttesttest")).toBeTruthy();
    expect(Schema.Types.password("testtesttesttesttestt")).toBeFalsy();
});